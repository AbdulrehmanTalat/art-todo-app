        ...
        <Box mt='-20'>
            <Box bg='#0987A0' mx={'auto'} w='80%' p={[8, 12, 14, 14, 20, 20]} color='white'>
                <Stack spacing={[1, 2, 2, 2, 3, 4]} direction='row' align='center'>
                    <Input value={todoName} onChange={(e)=> inputChange(e.target.value)} w={['320px', '375px', '425px', '768px', '1024px', '1740px']} height={['40']} size={['xs', 'sm', 'md', 'lg', 'lg', 'xl']} _placeholder={{ color: 'white' }} placeholder='add text here...' colorScheme='telegram' h={10} />
                    <WrapItem>
